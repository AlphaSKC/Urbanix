...
import { AppBar, Grid, Box, InputBase, Typography, Button, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, IconButton, Popover, Link } from '@mui/material';
                ...
                <Grid container alignItems="center">
                    ...
                    <Grid container xs={12} sm={12} md={4} lg={4} alignItems="center">
                        <Box>
                            ...
                            <Button sx={{ color: 'white', borderRadius: '20px' }} onClick={handleClick}>
