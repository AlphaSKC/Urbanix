...
import { Box, Button, CardActionArea, CardActions, Container, Card, CardContent, CardMedia, Typography, Avatar } from '@mui/material';
    ...
    return (
        <>
            ...
            <Box
                ...
                gap={2}
                marginTop={"40px"} >
                <Card variant="outlined" sx={{ width: "500px", height: "150px", backgroundColor: "#F5F6F8" }}>
                    <CardContent sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Box>
                            ...
                            <Typography>
                                Commerce is a global online marketplace, where people come together to make, sell, buy, and collect unique items.
                            </Typography>
                        </Box>
                        <Avatar
                            alt="Community"
                ...
                <Card variant="outlined" sx={{ width: "500px", height: "150px", backgroundColor: "#10E5A5" }}>
                    <CardContent sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Box>
                            <Typography sx={{ fontWeight: "bold", fontFamily: 'Poppins, sans-serif' }}>
